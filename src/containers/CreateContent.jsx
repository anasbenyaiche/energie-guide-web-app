    ...
    <div className=" max-w-7xl my-8 mx-auto">
      <div className=" px-6 flex items-center justify-between">
        ...
        <div className=" flex justify-center gap-4">
          <Link
            className="bg-[#00a2d6] border rounded-md border-[#00a2d6] focus:outline-none text-white px-5 py-2 hover:border-[#00a2d6]"
            to={`/admin/blocks/${id}`}
            target="_blank"
          >
            Preview
      ...
      <div className=" bg-white shadow-md p-4 mt-5 rounded-md">
        <div className=" flex items-start mt-5  gap-5">
          <div className=" p-2 w-1/3">
            ...
            <select
              className="w-full block mb-2 p-2 rounded-md bg-white text-black
