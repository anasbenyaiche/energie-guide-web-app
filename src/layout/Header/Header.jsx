            ...
            <div className=' grid grid-cols-4'>
                <div className=''>
                    <div className=' flex items-center justify-start gap-4'>
                        ...
                        <div className=' w-2/3'>
                            <div className='text-xs text-[#333333] font-medium'>République Tunisienne</div>
                            <div className=' text-[#04162E] font-bold'>
                                MINISTÈRE DE L'INDUSTRIE, DES MINES ET DE L’ÉNERGIE</div>
                        </div>
                    </div>
