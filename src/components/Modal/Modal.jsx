    ...
    return (
        ...
        >
            <div
                ...
                className={`bg-white lg:max-w-fit rounded-3xl max-lg:border-b-[5px]  mx-auto lg:rounded-3xl shadow w-full  px-5 py-3 transition-all ease-in-out duration-1000 
                ${open
